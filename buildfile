...
VERSION_NUMBER =  '2.6'#`git describe`.strip
...
RELEASE_REPO = 'http://dev01.ec2.brilig.net:8080/artifactory/libs-snapshot-local'
# RELEASE_REPO = 'http://dev01.ec2.brilig.net:8080/artifactory/libs-release-local'
# RELEASE_REPO = 'http://dev01.ec2.brilig.net:8080/artifactory/list/libs-release/'
# RELEASE_REPO = 'http://dev01.ec2.brilig.net:8080/artifactory/repo'
...
repositories.release_to[:password] = 'brilig123'
repositories.release_to[:url] = RELEASE_REPO
...
define "memcached" do
  ...
  #"org.jboss.netty:netty:jar:3.1.5.GA"
  
  compile.with "log4j:log4j:jar:1.2.15", "jmock:jmock:jar:1.2.0",
               "junit:junit:jar:4.4", "org.jboss.netty:netty:jar:3.2.3.Final",
